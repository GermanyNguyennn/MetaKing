...
public class MetaKingAdminDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public MetaKingAdminDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
