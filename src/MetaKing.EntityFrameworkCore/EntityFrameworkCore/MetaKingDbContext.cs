...
using MetaKing.Inventories;
using MetaKing.InventoryTickets;
...
public class MetaKingDbContext :
    AbpDbContext<MetaKingDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public MetaKingDbContext(DbContextOptions<MetaKingDbContext> options)
        : base(options)
    {
